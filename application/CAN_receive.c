...
uint16_t super_cap_mode = 0XC6 * 100;
...
//					super_cap_measure.InputVot = (float)pPowerdata[1] / 100.0f;//输入电压
//					super_cap_measure.CapVot = (float)pPowerdata[0] / 1000.0f;//电容电压
//					super_cap_measure.Test_current = (float)pPowerdata[2] ;//状态码
...
//void CAN_cmd_supercap(int16_t temPower ,uint16_t Power_buff)
//{
//		uint32_t send_mail_box;
//    chassis_tx_message.StdId = CAN_SUPER_CAP_SET_ID;
//    chassis_tx_message.IDE = CAN_ID_STD;
//    chassis_tx_message.RTR = CAN_RTR_DATA;
//    chassis_tx_message.DLC = 0x08;
//    chassis_can_send_data[0] = super_cap_mode >> 8;
//    chassis_can_send_data[1] = super_cap_mode;
//    chassis_can_send_data[2] = temPower >> 8;
//    chassis_can_send_data[3] = temPower;	
//    chassis_can_send_data[4] = Power_buff >> 8;
//    chassis_can_send_data[5] = Power_buff;		
